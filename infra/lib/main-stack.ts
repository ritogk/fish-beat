...
export class MainStack extends cdk.Stack {
  constructor(
    ...
    // ホストゾーンを取得
    const hostedZone = route53.HostedZone.fromHostedZoneAttributes(this, 'GetHostZone', {
    ...
    new route53.ARecord(this, 'CreateSubdomain', {
      ...
      target: route53.RecordTarget.fromAlias(new route53_targets.CloudFrontTarget(distribution2))
    })
  }
}
